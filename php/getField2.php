<?php 
	...
	$query = "SELECT subject.sub_name, branch.branch_name, teacher.teach_title, teacher.teach_name, teacher.teach_lname,subject_open.open_id,subject_open.open_division,subject_open.open_credit, subject_open.open_year, subject_open.open_section, subject_open.open_division,subject_open.open_status,subject_open.sub_id,subject_open.open_nstd , subject_open.teach_id
         	FROM subject_open
            ...
            where subject_open.open_status='9'";
